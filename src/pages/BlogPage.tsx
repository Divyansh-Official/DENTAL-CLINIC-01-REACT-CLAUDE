        ...
        <div className="px-6 md:px-12 py-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0.5 bg-[#E0E0E0]">
            {filtered.map((post) => (
              ...
              >
                {/* Cover image */}
                <div className="relative w-full h-48 overflow-hidden flex-shrink-0 bg-[#F0F0F0]">
                  {post.imageUrl ? (
                    <img
                      src={post.imageUrl}
                      alt={post.title}
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#F5F5F5] to-[#E8E8E8]">
                      <span className="text-[10px] font-bold tracking-[0.15em] uppercase text-[#C8C8C8]">
                        {post.category}
                      </span>
                    </div>
                  )}
                  {/* Category pill over image */}
                  <span className="absolute top-3 left-3 flex items-center gap-1.5 bg-white/90 backdrop-blur-sm text-[9px] font-bold tracking-[0.12em] uppercase text-[#555] px-2.5 py-1 rounded-full">
                ...
                <div className="flex flex-col flex-1 p-7 md:p-8">
                  {/* Read time */}
                  <div className="flex items-center gap-1.5 mb-4 text-[#8F8F8F]">
                    <Clock size={10} />
