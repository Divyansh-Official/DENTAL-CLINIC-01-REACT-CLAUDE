    ...
    <>
      ...
      <main className="pt-24 bg-[#0A0A0A] text-white min-h-screen">
        <div className="px-6 md:px-12 pt-10 pb-2">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-[12px] font-semibold text-[#8F8F8F] hover:text-white transition-colors"
          >
            <ArrowLeft size={13} /> Back to Home
          </Link>
        </div>

        <Doctors onBooking={() => setBooking(true)} />
      </main>
...
// import multipleDoctors from "../data/multipleDoctors.json";

// const certData = multipleDoctors[0].certifications;
